...
Модуль рассчитан на питание двигателей **3–33В** и ток нагрузки до **6А** на канал. Управляющая часть работает с логическими уровнями 3,3–5В и гальванически изолирована от силовой части.
...
INxA и INxB, где x — номер двигателя.
...
**Подробные примеры можно найти внутри папок - arduino-example/motors-driver | micropython-example | stm32f407-example/motor_drivers** 

***

<img width="1200" height="1200" alt="Снимок экрана 2026-07-22 212533" src="https://github.com/user-attachments/assets/f0af8e4c-b910-4d81-836f-3f8b615c1739" />
